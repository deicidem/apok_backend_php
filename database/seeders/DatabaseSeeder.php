...
class DatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        //     'preview_id'     => 10
        // ]);
        // $json    = json_decode(Storage::get('files/АВИМ/result/Архивный снимок 2.geojson'));
        ...
        //     'preview_id'     => 11
        // ]);
        // $json    = json_decode(Storage::get('files/АВИМ/result/Актуальный снимок 2.geojson'));
        // $polygon = json_encode(\GeoJson\GeoJson::jsonUnserialize($json)->getFeatures()[0]->getGeometry()->jsonSerialize());
        // TaskResultView::Create([
        ...
        //     'preview_id'     => 12
        // ]);
        // $json    = json_decode(Storage::get('files/АВИМ/result/Изменения.geojson'));
        // $polygon = json_encode(\GeoJson\GeoJson::jsonUnserialize($json)->getFeatures()[0]->getGeometry()->jsonSerialize());
        // TaskResultView::Create([
        //     'title'          => 'Изменения',
        //     'type_id'        => 2,
